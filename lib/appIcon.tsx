/* Gedeeld ontwerp voor het app-icoon (favicon + iPhone-tegel): Rotary-blauw
   met het gouden tandwiel en "Loterij". Gerenderd via next/og ImageResponse. */
export function AppIcon({ size }: { size: number }) {
  const gear = Math.round(size * 0.42);
  return (
    <div
      style={{
        width: '100%',
